      ...
      if (this.registerForm.invalid) {
        ...
        this.service.addUser(this.logSign).subscribe( data =>{
           ...
           else
           {
            ...
            this.snackBar.open('User created SuccessFully.'+" Your Employer Id is="+""+this.logSignNew.empId+" "+"Please make a note of this.",'Reset',{duration:10000,horizontalPosition:"right",verticalPosition:"top"});
